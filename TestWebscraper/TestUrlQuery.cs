...
namespace TestWebscraper
{
    ...
    public class TestUrlQuery
    {
        ...
        public void TestClenser()
        {
            ...
            Assert.AreEqual(q.ToString(), "?q=c%23+find+first+occurrence+of+string+in+string&oq=c%23+find+first+&aqs=chrome.2.69i57j0l6j69i58.5824j0j4&sourceid=chrome&ie=UTF-8");
